...
public class IsPrime {
	...
	public static void main(String[] args) {
		...
		//Declaring and initializing a variable "Count" to store the number of factors/Divisors
		...
		// if the number of factors is not equal to 2, the given number is printed as not a prime number
		else {
